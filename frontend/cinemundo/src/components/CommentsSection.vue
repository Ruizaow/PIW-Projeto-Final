  ...
  <div class="container-comentario">
    ...
    <div class="comment-section">
      <div class="comment-item">
        <div class="poster-comentario">
          <img src="" alt="Poster do filme">
        </div>
        <div class="comment">
          <div class="comment-header">
            <div class="comment-author">Juca Sincerão</div>
            <div class="rating">
          ...
          <div class="comment-content">
            ...
            filme apresenta um ritmo lento e uma duração excessiva que podem testar muito 
      ...
      <div class="comment-item">
        ...
        <div class="comment">
          <div class="comment-header">
            <div class="comment-author">Gerald</div>
            <div class="rating">
              <div></div><div></div><div></div><div></div><div></div>
            </div>
          </div>
          <div class="comment-content">
            ...
            ao consumismo e à degradação ambiental.
          </div>
        </div>
      </div>
    </div>
